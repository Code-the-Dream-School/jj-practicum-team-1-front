      ...
      <div className="max-w-7xl mx-auto px-4 py-3 flex items-center justify-between">
        ...
        <div className="hidden md:flex items-center gap-2">
          ...
          {!token ? (
            ...
            <>
              <NavLink to="/explorer" className={link}>Explore</NavLink>
              <NavLink to="/plants" className={link}>My Collection</NavLink>
              <button onClick={logout} className={linkBase}>Log Out</button>
            </>
          )}
        </div>
